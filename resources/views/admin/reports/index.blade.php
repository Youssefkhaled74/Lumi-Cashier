        ...
        <div class="flex items-center justify-between mb-4">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-800 mb-2">
                    <i class="bi bi-bar-chart-line text-indigo-600"></i> Reports & Analytics
                </h2>
                <p class="text-gray-600">View sales performance and inventory statistics</p>
            </div>
    ...
    @if($reportData === null)
        ...
        <div class="card shadow-2xl text-center py-16 animate-fadeInUp" style="animation-delay: 0.1s;">
            <div class="flex flex-col items-center">
                ...
                <h3 class="text-2xl font-bold text-gray-800 mb-2">Ready to Generate Report</h3>
                <p class="text-gray-600 mb-8 max-w-md">Select a date range above and click "Generate Report" to view detailed analytics and insights.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 w-full max-w-3xl">
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-xl">
                        ...
                        <h4 class="font-bold text-gray-800 mb-2">Sales Analytics</h4>
                        <p class="text-sm text-gray-600">Track revenue and order trends over time</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-xl">
                        ...
                        <h4 class="font-bold text-gray-800 mb-2">Inventory Status</h4>
                        <p class="text-sm text-gray-600">Monitor stock levels and low stock alerts</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl">
                        ...
                        <p class="text-sm text-gray-600">See your best-selling items</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            ...
            <div class="card shadow-2xl animate-fadeInUp" style="animation-delay: 0.2s;">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-semibold text-gray-600">Avg Order</p>
            ...
            <div class="card shadow-2xl animate-fadeInUp" style="animation-delay: 0.3s;">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-semibold text-gray-600">Days</p>
        ...
        @if($reportData['summary']['total_orders'] == 0)
            ...
            <div class="card shadow-2xl text-center py-12 animate-fadeInUp" style="animation-delay: 0.4s;">
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-gray-600 mb-6 max-w-md">There are no completed orders in the selected date range ({{ $reportData['summary']['date_range']['from'] }} - {{ $reportData['summary']['date_range']['to'] }}).</p>
        ...
        @else
            ...
            <div class="card shadow-2xl mb-6 animate-fadeInUp" style="animation-delay: 0.5s;">
                <h3 class="text-xl font-bold text-gray-800 mb-4">
                    <i class="bi bi-box-seam text-purple-600"></i> Inventory Overview
                </h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-gradient-to-br from-yellow-50 to-orange-50 p-4 rounded-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-semibold text-gray-600">Low Stock Items</p>
                    ...
                    <div class="bg-gradient-to-br from-red-50 to-pink-50 p-4 rounded-xl">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-semibold text-gray-600">Out of Stock</p>
            ...
            @if($reportData['top_selling_items']->isNotEmpty())
                <div class="card shadow-2xl mb-6 animate-fadeInUp" style="animation-delay: 0.6s;">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">
                        <i class="bi bi-trophy text-green-600"></i> Top Selling Items
                    </h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Product</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">SKU</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Qty Sold</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Revenue</th>
                                </tr>
                            </thead>
